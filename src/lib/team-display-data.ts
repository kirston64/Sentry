...
const displayData: Record<string, Omit<TeamMember, "id">> = {
  darkside: {
    ...
    bio: "Основатель и лид-разработчик Forge RP. 5 лет опыта в FiveM разработке. Отвечаю за архитектуру, CI/CD и серверную инфраструктуру. Бывший разработчик в Diamond RP.",
    joinedAt: "2024-06-15",
  ...
  nightwolf: {
    ...
    bio: "Специализируюсь на синхронизации транспорта и античит-системах. Написал кастомный античит для Forge RP с нуля. Увлекаюсь reverse engineering.",
    joinedAt: "2024-08-20",
    timezone: "UTC+3 Москва",
